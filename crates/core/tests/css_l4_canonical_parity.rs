...
// `grammar/css/l4/color.bbnf` lives in `bbnf::css_types`. The
// generated CSS L4 parser resolves the call against the bbnf library
// crate root, so this test reaches the function via `bbnf::css_types`
// instead of redefining it inline (REAUDIT-2026-04-30 lane 3 §5.1
// retired the 14 inline duplicates).
