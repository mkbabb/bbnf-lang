...
describe("BBNF Parser", () => {
    it("should parse a simple math grammar", () => {
        const grammar = fs.readFileSync("test/fixtures/grammar/lang/math.bbnf", "utf8");
    ...
    it("should parse a CSS color grammar", () => {
        const grammarPath = path.resolve("test/fixtures/grammar/css/css-color.bbnf");
    ...
    it("should parse an BBNF grammar", () => {
        let grammar = fs.readFileSync("test/fixtures/grammar/lang/bbnf.bbnf", "utf8");
    ...
    it("should parse JSON data", () => {
        const grammar = fs.readFileSync("test/fixtures/grammar/lang/json.bbnf", "utf8");

        const parser = JSONParser(grammar);

        const jsonData = fs.readFileSync("test/fixtures/data/json/data.json", "utf8");
    ...
    it("should parse a CSV grammar", () => {
        const grammar = fs.readFileSync("test/fixtures/grammar/lang/csv.bbnf", "utf8");
...
"John Doe",30,NYC`;
    ...
    it("should parse a BNF grammar", () => {
        const grammar = fs.readFileSync("test/fixtures/grammar/lang/bnf.bbnf", "utf8");
        const [nonterminals] = BBNFToParser(grammar);
...
<number> ::= "0" | "1" | "2"`;
    ...
    it("should compile an ambiguous math grammar", () => {
        const grammar = fs.readFileSync(
            "test/fixtures/grammar/lang/math-ambiguous.bbnf",
            "utf8",
        );
    ...
    it("should reject an emoji grammar with unquoted terminals", () => {
        const grammar = fs.readFileSync(
            "test/fixtures/grammar/lang/emoji.bbnf",
            "utf8",
        );
