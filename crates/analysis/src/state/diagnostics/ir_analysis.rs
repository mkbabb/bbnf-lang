...
pub(super) fn try_compile_ir(cached: &CachedParseResult<'_>) -> IrAnalysis {
    ...
    // `DirectiveSet::recovers` is typed over the BBNF rule RHS view
    // (post-cutover.D4: [`BbnfView`]); we hand the IR compile an
    ...
    // codegen.
    let recover_map: HashMap<String, BbnfView<'_, '_>> = HashMap::new();
...
fn format_type_desc(td: &bbnf_ir::TypeDesc, ir: &bbnf_ir::GrammarIR) -> String {
    match td {
        ...
        bbnf_ir::TypeDesc::I8 => "i8".into(),
        bbnf_ir::TypeDesc::U8 => "u8".into(),
        bbnf_ir::TypeDesc::I16 => "i16".into(),
        bbnf_ir::TypeDesc::U16 => "u16".into(),
        bbnf_ir::TypeDesc::I32 => "i32".into(),
        bbnf_ir::TypeDesc::U32 => "u32".into(),
        bbnf_ir::TypeDesc::I64 => "i64".into(),
        bbnf_ir::TypeDesc::U64 => "u64".into(),
