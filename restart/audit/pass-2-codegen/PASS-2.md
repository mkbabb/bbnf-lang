...
| Tier δ (V2 surfaces) | meta-grammar | NONE-IN-SCOPE | PASS-2 carries no V2-deferred meta-grammar surface; verification confirms zero "V2 amendment" / "V2 deferral" / "deferred to V2" phrases at PASS-2 §-prose surfaces (§A obligation-table column header retires the "V2 deferral route" framing per α1 fold). |
