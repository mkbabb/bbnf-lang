...
Date: 2026-05-14 (SK-V6 dispatch active)
Status: **SK-V6 WAVE 0 IN PROGRESS. Current measured authority is `skinny/RESULTS.md`: full gate `N-direct / NoGo`; retained parse has 13 G rows, with `canada`, `mesh`, `marine_ik`, and `numbers` A / GO. Canada structural scan is green in the refreshed full matrix at 41495 Mbps against the 40000 Mbps NEON floor. Direct correctness is green and four direct rows pass the sonic-rs 1.10x direct slack (`citm_catalog`, `mesh`, `marine_ik`, `numbers`); 13 direct rows remain red. Strictness/output-plane columns are disclosed. SK-V5 Waves 0-5 landed the Rust-state substrate and measured redress, but the Wave 3 UTF-8 fusion prescription is refuted by REDRESS 50-55. SK-V6 owns throughput recovery by re-profiling the new generated Track 1 baseline before any new kernel work.**
...
**Reading order for the next implementation agent**: `restart/skinny/audit/IMPLEMENTATION-AGENT-PROMPT-SK-V6.md` (dispatch authority) → `restart/skinny/audit/GRAND-SYNTHESIS-SK-V5.md` (post-assay substrate history) → `restart/skinny/audit/SK-V5-COHORT/` (15 cohort reports) → `restart/skinny/audit/HANDOFF-SK-V5.md` → `restart/skinny/audit/NUKE-PLAN-SK-V5.md` → `restart/skinny/audit/IMPLEMENTATION-PACKET-SK-V5.md`. The deleted SK-V3/SK-V4 and SK-V1/SK-V2 hardening artefacts are no longer dispatch inputs.
...
3. `restart/skinny/audit/IMPLEMENTATION-AGENT-PROMPT-SK-V6.md` — **SK-V6 dispatch authority**; supersedes SK-V5 dispatch, forbids hypothesis transfer from the refuted Wave 3 UTF-8 fusion prescription, and requires Wave 1 fresh profiles before any new kernel prescription.
4. `restart/skinny/audit/GRAND-SYNTHESIS-SK-V5.md` — **SK-V5 substrate-history authority**; 417 LOC; corrected SK-V5 audit diagnoses plus the 2026-05-14 post-assay header. Its original UTF-8-fusion close language is superseded by SK-V6 and REDRESS 50-55.
5. `restart/skinny/audit/SK-V5-COHORT/` — 15 cohort reports (5,559 LOC): A1 comparative, A2 dav1d-process, A3 parse-that-gaps, A4 tape-union-audit, A5 grammar-generalization, A6 research-ledger, B1 parse-attribution, B2 direct-attribution, B3 native-sidecars, D1 eisel-novelty, D2 utf8-novelty, D3 derive-shape-novelty, D4 simd-split-novelty, D5 sinkonly-novelty, D6 class-ab-novelty.
6. `restart/skinny/audit/HANDOFF-SK-V5.md`, `restart/skinny/audit/NUKE-PLAN-SK-V5.md`, and `restart/skinny/audit/IMPLEMENTATION-PACKET-SK-V5.md` — SK-V5 packet history and partial landed state.
