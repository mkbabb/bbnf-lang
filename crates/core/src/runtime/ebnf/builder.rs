...
impl<'p> SimpleValue<'p> for EbnfValue<'p> {
    ...
    fn from_compound_index(id_plus_one: u32) -> Self {
        EbnfValue::Compound(crate::runtime::ebnf::arena::EbnfCompoundId::from_raw(
            id_plus_one,
        ))
    }
}
...
pub type EbnfStructBuilder<'p> = SimpleStructBuilder<'p, EbnfValue<'p>, EbnfCompound<'p>>;
pub type EbnfStructCheckpoint<'p> =
    crate::runtime::builder_template::SimpleCheckpoint<'p, EbnfValue<'p>>;
