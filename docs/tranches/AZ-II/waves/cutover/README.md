...
[`G`](G.md), [`H`](H.md), [`I`](I.md),
[`J`](J.md), [`K`](K.md), [`L`](L.md),
[`M`](M.md), [`N`](N.md), and [`O`](O.md).
...
3. **[O2 EBNF direct projection](O2.md)** — LANDED: large literal alternates
