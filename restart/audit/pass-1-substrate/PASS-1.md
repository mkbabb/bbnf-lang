...
| `BBNF-CLOSURE-CAPTURE-BY-MOVE` | `closure body in {rule} captures {binding} by move; V1 closures capture by &'i Tape<'i> reference only — rewrite the capture as a borrow, or wait for V2 capture-by-move amendment.` |
