...
| `docs/benchmarks/archive/AZ-II/cutover/O5-tape-delete-scan.txt` | create |
...
Files touched: `docs/benchmarks/archive/AZ-II/cutover/O5-tape-delete-scan.txt`.
...
5. `docs/benchmarks/archive/AZ-II/cutover/O5-tape-delete-scan.txt` records zero production `runtime::tape`, `TapeCursor`, `TapeRec`, `TapeOffset`, or `crates/tape` hits outside historical docs.
