...
against live LOCKS.md). Pass Omega V10 (astral) **G-Omega V10 CLOSED 2026-06-01**;
the CRUD wave is applied to the V1 surfaces.
...
SK-V17 tape-fold contract is HISTORICAL provenance below; the CURRENT tranche
...
into the totality `crates/core/` tree is **SK-V19**, NOT SK-V18. No SK-V18 wave
dispatches until the required V1 patches are authorized at this G-Omega. Current SK-V17
...
## Pass Omega V5 SK-V17 tape-fold dispatch directive (HISTORICAL provenance — superseded by the Next-Cycle Dispatch Directive below)
...
5. **G-Omega V10 (mandatory user gate)** authorizes the required V1 patches
   ...
   is v+1. **G-Omega V10 CLOSED 2026-06-01.**
