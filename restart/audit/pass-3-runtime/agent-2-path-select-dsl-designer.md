...
| Hardcoded grammar registry | Current `registry.rs` maps only `Json`, `CssL4`, `Sheets`, and `Bbnf` marker names (`crates/bbnf-path/src/registry.rs:80-98`). | Simple for fixtures. | Violates Lock 14 generality and no-overfit guidance (`restart/locks/LOCKS.md:60`, `restart/README.md:11-25`). | Replace with metadata discovery generated for every grammar. | DISCARD |
