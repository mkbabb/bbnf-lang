...
- **BA opens after AZ-IV close + the 8-lane meta-audit hardening pass** (handoff at `docs/tranches/AZ-IV/audit/HANDOFF-HARDENING-PROMPT.md`); BA.W0 absorbs the 3 cleanup commits as its first scope items rather than as a separate pre-BA phase.
