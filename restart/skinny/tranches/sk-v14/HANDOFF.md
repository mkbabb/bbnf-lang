...
```
JSON parse_only: 9 / 17  (8 OPEN after W10T residual implementation)
...
- JSON parse_only: 9 / 17 ADMITTED, 8 OPEN under REDRESS-220.
...
5. W10 is closed mixed: 6 parse_only admits and 11 parse_only open rows under
   ...
   `unicode_mixed/parse_only`, and W10T admits `instruments/parse_only`,
   leaving 8 parse_only open rows under REDRESS-220.
