...
| 4 | Rule storage, ranker, human review | BB + every grammar | Grammar-specific rules colocated, fleet-wide in `crates/ir/src/rewrites/`; mandatory ranker; 3-tier review | [04-rule-storage-ranker-review.md](04-rule-storage-ranker-review.md) |
