...
|---|---|
| `restart/prompts/sub-orchestrators/HARDENING.md:55-77` | Phase 3 dispatches four target hardeners; each applies nine-lane audit and returns READY / AMENDMENT-REQUIRED / RE-DRAFT. |
| `restart/prompts/sub-orchestrators/HARDENING.md:79-118` | Phase 6 consolidates cross-target conflicts only after all hardening reports commit. |
| `restart/prompts/audit-specs/HARDENING-LENS-SET.md:35-42` | Pro / Con / Explication / Challenge discipline is mandatory. |
| `restart/prompts/audit-specs/HARDENING-LENS-SET.md:109-147` | Nine-lane table, gate rerun, binding ledger, punch-list, and final verdict shape. |
| `restart/prompts/audit-specs/HARDENING-LENS-SET.md:169-177` | Hardening writes only its report and does not relitigate the settled locks. |
| `restart/prompts/sub-orchestrators/AMENDMENT-DISPATCH.md:58-68` | Verify existing absorption before patching; route fixture-separation correctly to PASS-3 when needed. |
...
| H - wrong lock provenance | V5 flagged PASS-3 SOTA citation to wrong lock (`HARDENING-PASS-3-V5.md:138`, `:277`). | PASS-3 cites Lock 8 at `restart/locks/LOCKS.md:48` (`PASS-3.md:476`, `:488`). | CLEAN |
...
|---|---|---|---|
| One tape/direct identity | `PASS-3.md:184-186` | Lock 1 (`restart/locks/LOCKS.md:34`); ARCH one identity smoke (`restart/ARCHITECTURE.md:1237`); MIG runtime gate (`restart/MIGRATION.md:751-753`) | CLOSED |
...
| Fixture and yaml onboarding separation | `PASS-3.md:407-412`, `:429-431` | README two surfaces (`restart/README.md:13`); Lock 14 (`restart/locks/LOCKS.md:60`); ARCH yaml row (`restart/ARCHITECTURE.md:1400`) | CLOSED |
