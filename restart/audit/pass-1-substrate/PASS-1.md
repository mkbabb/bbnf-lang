...
|---|---|---|---|
| Tape substrate | 1, 4, 6 | `restart/README.md:285`-`restart/README.md:315`; `restart/locks/LOCKS.md:34` | KEEP tape as substrate and union it with direct-to-struct. |
...
| CSP/e-graph | 3 | `restart/README.md:219`-`restart/README.md:228`; `restart/locks/LOCKS.md:40` | KEEP bridged, per-domain composition. |
| Cost model | 4 | `restart/README.md:211`-`restart/README.md:218`; `restart/locks/LOCKS.md:48` | KEEP `CostModel` / `CostDecision` scoring with SOTA gates, objective evidence, and extraction evidence. |
...
This layout follows the README’s greenfield workspace direction (`restart/README.md:29`-`restart/README.md:63`) and Lock 13’s no-god-directory rule (`restart/locks/LOCKS.md:58`).
