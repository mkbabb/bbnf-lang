...
| **W0a.close** | [waves/W0a.close.md](waves/W0a.close.md) | Pre-W0b 17-entry bench baseline (`docs/benchmarks/archive/post-AX-W0a-close.json`) — attribution anchor for every downstream wave | W0a |
