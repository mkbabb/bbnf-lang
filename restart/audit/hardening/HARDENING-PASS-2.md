...
| `restart/locks/14-LOCKS.md` | 14-lock audit standard; especially Locks 1, 5, 8, 13, 14 (`restart/locks/14-LOCKS.md:34-60`, `restart/locks/14-LOCKS.md:118-125`) |
...
| `restart/audit/pass-2-codegen/PASS-2.md:137-258`, `restart/audit/pass-2-codegen/PASS-2.md:310` | Lock 13: no god directories | PASS-2 gives codegen/runtime/host/simd/xtask trees and exempts generated files from file cap only. | It responds to CENSUS god modules (`restart/corpora/CENSUS.md:321-354`) and Lock 13 (`restart/locks/14-LOCKS.md:58`). | The tree lists modules but not target file counts or child-count proof. | Add a non-generated LOC/child-count budget table. The architecture remains sound. | KEEP |
...
| Site (path:line) | Item | Explication | Pros | Cons | Challenge | Verdict |
|---|---|---|---|---|---|---|
| `restart/audit/pass-2-codegen/PASS-2.md:297-308`, `restart/audit/pass-2-codegen/agent-6-codegen-coherence-auditor.md:47-58` | grammar names in generated LOC budget | The target uses grammar names as per-X budget rows. | This is ratified: budgets must be per grammar per Lock 14 budget block (`restart/locks/14-LOCKS.md:118-125`). | Budget rows alone do not prove onboarding generality. | Keep the budget table; add onboarding proof elsewhere. | KEEP |
| `restart/audit/pass-2-codegen/agent-6-codegen-coherence-auditor.md:40` | grammar-name `rg` verification command | The command searches for forbidden public types in generic crates. | This is a legitimate audit anchor derived from Lock 14 (`restart/locks/14-LOCKS.md:60`). | It names only four legacy markers. | Add the full current marker set or a metadata-driven deny-list generated from workspace metadata. | KEEP |
