...
These are candidate primitive implications, not selected waves or an implementation order.
...
- `restart/prompts/ORCHESTRATOR.md:374` and `restart/prompts/ORCHESTRATOR.md:474` for convergence constraints, scalar references, same-wave consumers, and Lock 1/14 boundaries.
...
- `restart/skinny/tranches/sk-v12/skv12-p1-capture-manifest.md:45` for replay capture scope and `restart/skinny/tranches/sk-v12/skv12-p1-capture-manifest.md:145` for derived self-time tables.
- `restart/skinny/tranches/sk-v12/skv12-p1-replay.tsv:1` for replay command log.
...
- `restart/skinny/tranches/sk-v11/research/p2/p2a-sota-teardown.md:36` and `restart/skinny/tranches/sk-v11/research/p2/HARDENING-S-P2-CONVERGED.md:23` as historical P2 context only.
