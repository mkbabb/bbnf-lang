...
G-Omega is **mandatory** before any locks amendment merges to `restart/locks/LOCKS.md`. The orchestrator presents to the user:
...
restart/locks/LOCKS.md    ← v+1 (CRUD-3, post-G-Omega)
