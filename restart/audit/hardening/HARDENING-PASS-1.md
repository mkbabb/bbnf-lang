...
| Ground truth read | `restart/README.md`; `restart/locks/LOCKS.md`; `docs/precepts/instructions/{STYLE,LESSONS-LEARNED,CONSUMING}.md`; `restart/prompts/{PASS-1-SUBSTRATE,PASS-2-CODEGEN,PASS-3-RUNTIME,SYNTHESIS}.md`; `restart/corpora/{CENSUS,MODULES,RESTART-SKETCH,SOTA}.md`; `restart/inheritance/INDEX.md` |
