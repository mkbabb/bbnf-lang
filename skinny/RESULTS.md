...
|---|---|---|---|---|---|---:|---:|---:|---:|---:|---:|---|
| twitter | direct_to_struct | deferred | view-boundary | yes | JSONTestSuite n_string_unescaped_ctrl_char rejected; direct rows bench-private until Wave 2 | 9849 | 9814 | 11604 | 8506 | 84.9% | 84.6% | NO-GO sink_only throughput > sonic-rs * 1.10 ns slack; correctness PASS; Track 1 9849, Track 2 9814, sonic 11604 Mbps |
| citm_catalog | direct_to_struct | deferred | view-boundary | yes | JSONTestSuite n_string_unescaped_ctrl_char rejected; direct rows bench-private until Wave 2 | 25291 | 25345 | 21615 | 14067 | 117.0% | 117.3% | PASS sink_only track1=track2=serde; sonic shape parity; throughput within gate |
| canada | direct_to_struct | deferred | view-boundary | yes | JSONTestSuite n_string_unescaped_ctrl_char rejected; direct rows bench-private until Wave 2 | 5105 | 5099 | 12512 | 8012 | 40.8% | 40.8% | NO-GO sink_only throughput > sonic-rs * 1.10 ns slack; correctness PASS; Track 1 5105, Track 2 5099, sonic 12512 Mbps |
| apache_builds | direct_to_struct | deferred | view-boundary | yes | JSONTestSuite n_string_unescaped_ctrl_char rejected; direct rows bench-private until Wave 2 | 11083 | 11141 | 10051 | 7617 | 110.3% | 110.8% | PASS sink_only track1=track2=serde; sonic shape parity; throughput within gate |
| github_events | direct_to_struct | deferred | view-boundary | yes | JSONTestSuite n_string_unescaped_ctrl_char rejected; direct rows bench-private until Wave 2 | 10595 | 10625 | 10825 | 8427 | 97.9% | 98.1% | PASS sink_only track1=track2=serde; sonic shape parity; throughput within gate |
| update_center | direct_to_struct | deferred | view-boundary | yes | JSONTestSuite n_string_unescaped_ctrl_char rejected; direct rows bench-private until Wave 2 | 9140 | 9187 | 9179 | 6718 | 99.6% | 100.1% | PASS sink_only track1=track2=serde; sonic shape parity; throughput within gate |
| mesh | direct_to_struct | deferred | view-boundary | yes | JSONTestSuite n_string_unescaped_ctrl_char rejected; direct rows bench-private until Wave 2 | 4987 | 5003 | 9606 | 7909 | 51.9% | 52.1% | NO-GO sink_only throughput > sonic-rs * 1.10 ns slack; correctness PASS; Track 1 4987, Track 2 5003, sonic 9606 Mbps |
| random | direct_to_struct | deferred | view-boundary | yes | JSONTestSuite n_string_unescaped_ctrl_char rejected; direct rows bench-private until Wave 2 | 6676 | 6667 | 9157 | 6212 | 72.9% | 72.8% | NO-GO sink_only throughput > sonic-rs * 1.10 ns slack; correctness PASS; Track 1 6676, Track 2 6667, sonic 9157 Mbps |
| gsoc-2018 | direct_to_struct | deferred | view-boundary | yes | JSONTestSuite n_string_unescaped_ctrl_char rejected; direct rows bench-private until Wave 2 | 5724 | 5744 | 8516 | 7757 | 67.2% | 67.5% | NO-GO sink_only throughput > sonic-rs * 1.10 ns slack; correctness PASS; Track 1 5724, Track 2 5744, sonic 8516 Mbps |
| marine_ik | direct_to_struct | deferred | view-boundary | yes | JSONTestSuite n_string_unescaped_ctrl_char rejected; direct rows bench-private until Wave 2 | 6458 | 6429 | 8799 | 7606 | 73.4% | 73.1% | NO-GO sink_only throughput > sonic-rs * 1.10 ns slack; correctness PASS; Track 1 6458, Track 2 6429, sonic 8799 Mbps |
| instruments | direct_to_struct | deferred | view-boundary | yes | JSONTestSuite n_string_unescaped_ctrl_char rejected; direct rows bench-private until Wave 2 | 15877 | 16054 | 12974 | 9809 | 122.4% | 123.7% | PASS sink_only track1=track2=serde; sonic shape parity; throughput within gate |
| numbers | direct_to_struct | deferred | view-boundary | yes | JSONTestSuite n_string_unescaped_ctrl_char rejected; direct rows bench-private until Wave 2 | 4301 | 4317 | 12974 | 8759 | 33.1% | 33.3% | NO-GO sink_only throughput > sonic-rs * 1.10 ns slack; correctness PASS; Track 1 4301, Track 2 4317, sonic 12974 Mbps |
| unicode_mixed | direct_to_struct | deferred | view-boundary | yes | JSONTestSuite n_string_unescaped_ctrl_char rejected; direct rows bench-private until Wave 2 | 3197 | 3199 | 6406 | 3747 | 49.9% | 49.9% | NO-GO sink_only throughput > sonic-rs * 1.10 ns slack; correctness PASS; Track 1 3197, Track 2 3199, sonic 6406 Mbps |
| unicode_escapes | direct_to_struct | deferred | view-boundary | yes | JSONTestSuite n_string_unescaped_ctrl_char rejected; direct rows bench-private until Wave 2 | 4574 | 4576 | 9072 | 4336 | 50.4% | 50.4% | NO-GO sink_only throughput > sonic-rs * 1.10 ns slack; correctness PASS; Track 1 4574, Track 2 4576, sonic 9072 Mbps |
| unicode_basic | direct_to_struct | deferred | view-boundary | yes | JSONTestSuite n_string_unescaped_ctrl_char rejected; direct rows bench-private until Wave 2 | 4856 | 4859 | 7092 | 4947 | 68.5% | 68.5% | NO-GO sink_only throughput > sonic-rs * 1.10 ns slack; correctness PASS; Track 1 4856, Track 2 4859, sonic 7092 Mbps |
| distinct_values | direct_to_struct | deferred | view-boundary | yes | JSONTestSuite n_string_unescaped_ctrl_char rejected; direct rows bench-private until Wave 2 | 12370 | 12461 | 11677 | 7552 | 105.9% | 106.7% | PASS sink_only track1=track2=serde; sonic shape parity; throughput within gate |
| y_string_unicode | direct_to_struct | deferred | view-boundary | yes | JSONTestSuite n_string_unescaped_ctrl_char rejected; direct rows bench-private until Wave 2 | 5620 | 5671 | 8547 | 7172 | 65.8% | 66.4% | NO-GO sink_only throughput > sonic-rs * 1.10 ns slack; correctness PASS; Track 1 5620, Track 2 5671, sonic 8547 Mbps |
...
- twitter peak RSS subprocess probes: bbnf=3620864 bytes, S anchor sonic-rs=4898816 bytes.
...
- citm_catalog peak RSS subprocess probes: bbnf=4849664 bytes, S anchor sonic-rs=7733248 bytes.
...
- canada peak RSS subprocess probes: bbnf=5898240 bytes, S anchor sonic-rs=11321344 bytes.
...
- apache_builds peak RSS subprocess probes: bbnf=2785280 bytes, S anchor sonic-rs=3080192 bytes.
...
- github_events peak RSS subprocess probes: bbnf=2785280 bytes, S anchor sonic-rs=3047424 bytes.
...
- update_center peak RSS subprocess probes: bbnf=3424256 bytes, S anchor sonic-rs=4489216 bytes.
...
- mesh peak RSS subprocess probes: bbnf=3686400 bytes, S anchor sonic-rs=6144000 bytes.
...
- random peak RSS subprocess probes: bbnf=3424256 bytes, S anchor sonic-rs=4718592 bytes.
...
- gsoc-2018 peak RSS subprocess probes: bbnf=6225920 bytes, S anchor sonic-rs=10158080 bytes.
...
- numbers peak RSS subprocess probes: bbnf=2719744 bytes, S anchor sonic-rs=3211264 bytes.
...
- unicode_mixed peak RSS subprocess probes: bbnf=3948544 bytes, S anchor sonic-rs=5636096 bytes.
...
- unicode_escapes peak RSS subprocess probes: bbnf=3817472 bytes, S anchor sonic-rs=5128192 bytes.
...
- unicode_basic peak RSS subprocess probes: bbnf=4079616 bytes, S anchor sonic-rs=6455296 bytes.
...
- distinct_values peak RSS subprocess probes: bbnf=2801664 bytes, S anchor sonic-rs=3194880 bytes.
