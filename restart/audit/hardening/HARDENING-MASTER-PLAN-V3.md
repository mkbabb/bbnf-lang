...
- (b) Replace every `passes::layout` reference with `passes::types` in §6/§7.3/§8.2/MASTER-PLAN C.W1, AND amend Lock 2 at `restart/locks/LOCKS.md:36` to read `passes::types` instead of `passes::layout`. (Higher friction; Lock 2 is settled.)
