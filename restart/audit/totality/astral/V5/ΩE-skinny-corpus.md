...
the source-consuming runtime generator contract is W5A before deletion.
...
| `restart/skinny/WORKSPACE.md` | Update provider/template deletion ownership: W5A creates load-bearing source-consuming generator; W5B deletes providers/templates. |
...
| `restart/skinny/COMPILER.md` | Limited wording alignment for source-consuming runtime emission request before provider deletion. |
