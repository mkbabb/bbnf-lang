...
- **Direct memchr emission**: `fast_paths::emit_regex_direct_call` handles negated character class patterns `[^XYZ]+` and `[^XYZ]*`, emitting inline `memchr::memchr1/2/3` calls that bypass SpanParser enum dispatch.
