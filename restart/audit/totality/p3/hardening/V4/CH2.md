...
| check | result |
|---|---|
| `git show --stat --oneline e6c1c2a84 -- restart/audit/totality/p3` | Pass: target packet changes only the seven T-P3 proposal artifacts, with 170 insertions and 123 deletions. |
| `git diff --check e6c1c2a84^ e6c1c2a84 -- restart/audit/totality/p3` | Pass: no whitespace output. |
| Extract `3C-locks-v+1-diff.md` to `/tmp/tp3-locks-v4.diff`; `git apply --check /tmp/tp3-locks-v4.diff` | Pass: proposed lock addendum applies cleanly. |
