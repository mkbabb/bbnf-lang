...
<template>
    <div class="relative px-2 sm:px-4 pb-2 pt-1 h-12">
        <GlassDock class="absolute left-1/2 bottom-1 -translate-x-1/2" :collapse-delay="2000" :start-collapsed="true" :fit-content="true">
            <!-- Expanded state -->
