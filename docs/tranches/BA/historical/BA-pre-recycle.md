> **STATUS: SUBSUMED INTO AZ-IV at master c2a1c39e (2026-05-01); LETTER RECYCLED FOR RULE DISCOVERY.**
>
> This document is preserved at `docs/tranches/BA/historical/BA-pre-recycle.md` for archaeology only. The pre-recycle BA scope (typed path/query macro, lazy bail-out parse, host bindings — Rust + TS + Python) was absorbed into AZ-IV waves W2 / W3 / W5 per the 18-question interrogation pass 4 settling. The Python binding was dropped from the thesis (Q-final-4). The new BA at `../BA.md` is the post-AZ-IV rule-discovery successor.
>
> Do NOT cite this file as authoritative for execution. Cite `docs/tranches/AZ-IV/AZ-IV.md` instead.
