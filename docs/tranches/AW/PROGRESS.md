...
- **§Pivot** added (30 lines) documenting the W0a.2.h shape-emission-authoritative pivot: cites `docs/benchmarks/archive/post-AX-W0a2g-progress.md` §Remaining-blockers (four deferred walker-parity deltas) + `docs/tranches/AX/audit/R4-plan-redress.md` (invariant 20). Positions walker-parity chasing as a category-error the arc inherited, not a shape-emitter defect.
