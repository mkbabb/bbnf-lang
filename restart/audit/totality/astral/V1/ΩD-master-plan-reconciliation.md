...
| H.W4.LOCK14 | partial/pending | GrammarConfig legality is concrete evidence, but it is not fleet-wide grammar-neutral Lock 14 repair until CSS plus both Sheets and BBNF-self fail-closed or generated-role witnesses pass. | `restart/MASTER-PLAN.md:532`, `skinny/REDRESS.md:3555-3601` |
...
| H.W4.LOCK14 | Rename to `Lock 14 provider/config/sink repair`, scoped as partial until generated non-JSON plus both Sheets and BBNF-self fail-closed or generated-role witnesses pass. | 60-160 doc LOC; high generality risk. | LOCKS diff, generated-provider registry, Sheets/BBNF-self witnesses. |
...
| MP.NW6 | Lock 14 generated provider/config/sink/fact/flag/schema repair with CSS plus both Sheets and BBNF-self fail-closed or generated-role witnesses before fleet-wide grammar-neutral closure. | 700-2000 LOC, cap 2600; high generality risk. | Lock 14, generated registry, non-JSON witnesses. |
...
| MP.NW11 | Both Sheets and BBNF-self fail-closed or generated-role witnesses for generated role facts and future grammar onboarding; one witnessed grammar remains scoped, not fleet-wide grammar-neutral closure. | 250-800 LOC; medium-high risk. | Lock 14 and future grammar onboarding gates. |
...
| Witness cardinality resolved by CH2 | MP.NW6/MP.NW11 require both Sheets and BBNF-self fail-closed or generated-role witnesses before MASTER, HANDOFF, BENCH, or S-P3 may call the result fleet-wide grammar-neutral; one negative-control witness plus CSS is only a scoped non-JSON witness. | `restart/audit/totality/p3/3E-grammar-generalisation.md:132-143`, `restart/audit/totality/astral/V1/hardening/CH2.md:36-42` |
