...
mod __cssprettyparser_emit_impl {
    ...
    pub const GRAMMAR_CssPrettyParser: [&'static str; 1usize] = [
        include_str!("/Users/mkbabb/Programming/bbnf-wt-b2-w1/grammar/css/pretty.bbnf"),
    ];
    ...
    /// `RuleKind` enum.
    #[inline(always)]
    fn project_rule_kind_CssPrettyParser(variant_idx: u8) -> CssPrettyParserRuleKind {
        match variant_idx {
            0u8 => CssPrettyParserRuleKind::important,
            1u8 => CssPrettyParserRuleKind::declaration,
            2u8 => CssPrettyParserRuleKind::blockContent,
    ...
    fn project_frame_CssPrettyParser<'p>(
        ...
        match project_rule_kind_CssPrettyParser(frame.variant_idx) {
            ...
            CssPrettyParserRuleKind::declaration => {
                ...
                for (child_off, _child_frame) in output.value_children(offset) {
                    children
                        .push(project_frame_CssPrettyParser(output, input, child_off));
                }
