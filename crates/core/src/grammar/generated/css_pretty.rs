    ...
    impl<'p> importantView<'p> {
        ...
        pub fn rule_kind(&self) -> CssPrettyParserRuleKind {
            match self.variant_idx() {
                ...
                1u8 => CssPrettyParserRuleKind::importRule,
                2u8 => CssPrettyParserRuleKind::declaration,
                3u8 => CssPrettyParserRuleKind::genericAtRule,
                ...
                8u8 => CssPrettyParserRuleKind::atRuleBody,
                9u8 => CssPrettyParserRuleKind::ruleBlock,
                10u8 => CssPrettyParserRuleKind::blockContent,
