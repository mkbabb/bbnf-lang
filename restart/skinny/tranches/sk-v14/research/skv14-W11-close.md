...
|---|---:|---:|---:|---|
| JSON parse_only | 6 | 11 | 0 | W10 cold `profile_direct` evidence and REDRESS-217. |
...
3. Missing JSON typed products remain for `canada`, `gsoc-2018`,
   ...
   `y_string_unicode`.
4. JSON parse_only residuals remain for `twitter`, `citm_catalog`, `canada`,
...
W11 closes SK-V14 as a mixed tranche, with admitted rows preserved and all
