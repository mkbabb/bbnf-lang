...
| COH-016 | Generated CSS runtime FNV input hashes must be fenced as hash-sidecar / telemetry coupling before any CSS close claim. | The V4 FNV line-position transcript below lists all seven CSS generated runtime files at root-resolving path:line positions for `source\tinput_fnv64` and `fn fnv64`. The generator template emits the same surfaces at `skinny/crates/codegen/src/runtime_generator.rs:737`, `skinny/crates/codegen/src/runtime_generator.rs:783`, and `skinny/crates/codegen/src/runtime_generator.rs:1331`. | hash-sidecar coupling | unknown | Treat as telemetry-only output-plane metadata unless W10 proves otherwise. It is not CSS Value API proof, retained document identity, same-substrate evidence, or a production equality arbiter. |

## V4 FNV Line-Position Transcript

| CSS profile | input-hash output cites | helper cite |
|---|---|---|
...
| No production FNV/hash-sidecar quarantine proof for generated CSS runtimes. | CSS generated runtimes emit `input_fnv64` and define `fnv64`; COH-016's V4 transcript lists all seven runtime files at root-resolving path:line positions. Template sites are `skinny/crates/codegen/src/runtime_generator.rs:737`, `skinny/crates/codegen/src/runtime_generator.rs:783`, and `skinny/crates/codegen/src/runtime_generator.rs:1331`. | W10 FNV quarantine |
