...
| BB.W2 | Cohort template emission shrinks simple grammars. | BB-G5 runtime shrink at `docs/tranches/BB/BB.md:19`; generated table gives cohort targets at `docs/tranches/BB/BB.md:108-112`. | partial | Add W2 gate: each cohort generated parser <= table target; runtime instantiation <=50 LOC each is separate. |
...
| BC.W3 | Crate split relocates files, no regen. | Stated at `docs/tranches/BC/BC.md:100`. | honored | No surgery. |
