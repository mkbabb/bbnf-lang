...
/// reader.
fn agg_u8<R>(tape: &Tape<R>, rec: bbnf::runtime::tape::TapeRec) -> Option<u8> {
...
fn agg_f64<R>(tape: &Tape<R>, rec: bbnf::runtime::tape::TapeRec) -> Option<f64> {
...
fn walk<'t, R>(tape: &'t Tape<R>, cursor: TapeCursor<'t, R>, source: &[u8], out: &mut Vec<Leaf>) {
